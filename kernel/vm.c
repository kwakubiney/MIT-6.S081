...
//i thinj sth should be passing this page table to it.
pagetable_t
kvminitforuserproc()
{
...
void
kvmmapforuserproc(pagetable_t pagetable, uint64 va, uint64 pa, uint64 sz, int perm)
{
  if(mappages(pagetable, va, sz, pa, perm) != 0)
    panic("kvmmapforuserproc");
}
